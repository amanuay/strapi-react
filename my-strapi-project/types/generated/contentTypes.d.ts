...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    copyright: Schema.Attribute.Component<'copyright.copyright-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'cta.cta', false>;
    designed_by: Schema.Attribute.Component<'designed-by.designed-by', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    school_info: Schema.Attribute.Component<'school-info.school-info', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_types: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-type.event-type'
    >;
...
export interface ApiSchoolInformationSchoolInformation
  extends Struct.SingleTypeSchema {
  collectionName: 'school_informations';
  info: {
    displayName: 'School Information';
    pluralName: 'school-informations';
    singularName: 'school-information';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::school-information.school-information'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::school-information.school-information': ApiSchoolInformationSchoolInformation;
